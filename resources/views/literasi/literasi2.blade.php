...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 2</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{($hasil1=$data1->alb*12.07+$data1->alp*52.51+$data1->alt*-36.47+$data1->ast*19.19+$data1->bil*5.91+$data1->ggt*129.86)}}</td>
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{($hasil1=$data2->alb*12.07+$data2->alp*52.51+$data2->alt*-36.47+$data2->ast*19.19+$data2->bil*5.91+$data2->ggt*129.86)}}</td>
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                           <td>{{($hasil1=$data3->alb*12.07+$data3->alp*52.51+$data3->alt*-36.47+$data3->ast*19.19+$data3->bil*5.91+$data3->ggt*129.86)}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data4->alb*-30.14+$data4->alp*-14.72+$data4->alt*-69.05+$data4->ast*-28.15+$data4->bil*0.42+$data4->ggt*99.98}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 5--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data5->alb*-30.14+$data5->alp*-14.72+$data5->alt*-69.05+$data5->ast*-28.15+$data5->bil*0.42+$data5->ggt*99.98}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 6--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                          <td>{{ $hasil1=$data6->alb*-30.14+$data6->alp*-14.72+$data6->alt*-69.05+$data6->ast*-28.15+$data6->bil*0.42+$data6->ggt*99.98}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 7--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data7->alb*-30.14+$data7->alp*-14.72+$data7->alt*-69.05+$data7->ast*-28.15+$data7->bil*0.42+$data7->ggt*99.98}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 8--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data8->alb*11.53+$data8->alp*22.45+$data8->alt*-53.3+$data8->ast*-12.13+$data8->bil*8.07+$data8->ggt*115.19}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 9--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data9->alb*-26.45+$data9->alp*-15.26+$data9->alt*-85.52+$data9->ast*-40.12+$data9->bil*-6.42+$data9->ggt*95.84}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 10--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data10->alb*19.36+$data10->alp*43.69+$data10->alt*-64.64+$data10->ast*-21.04+$data10->bil*-0.21+$data10->ggt*108.17}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 11--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data11->alb*19.36+$data11->alp*43.69+$data11->alt*-64.64+$data11->ast*-21.04+$data11->bil*-0.21+$data11->ggt*108.17}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 12--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data12->alb*-17.45+$data12->alp*-8.87+$data12->alt*-82.73+$data12->ast*-44.89+$data12->bil*-2.55+$data12->ggt*96.74}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 13--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data13->alb*24.22+$data13->alp*55.75+$data13->alt*-62.03+$data13->ast*-22.21+$data13->bil*7.44+$data13->ggt*113.93}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 14--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data14->alb*-11.42+$data14->alp*-3.56+$data14->alt*-119.9+$data14->ast*-57.76+$data14->bil*4.92+$data14->ggt*92.24}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 15--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data15->alb*23.77+$data15->alp*76.9+$data15->alt*-106.04+$data15->ast*-36.07+$data15->bil*8.61+$data15->ggt*103.04}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 16--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data16->alb*23.77+$data16->alp*76.9+$data16->alt*-106.04+$data16->ast*-36.07+$data16->bil*8.61+$data16->ggt*103.04}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 17--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data17->alb*-17.63+$data17->alp*24.61+$data17->alt*-125.3+$data17->ast*-62.44+$data17->bil*2.4+$data17->ggt*73.97}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 18--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data18->alb*-17.63+$data18->alp*24.61+$data18->alt*-125.3+$data18->ast*-62.44+$data18->bil*2.4+$data18->ggt*73.97}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 19--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data19->alb*22.24+$data19->alp*88.96+$data19->alt*-110.99+$data19->ast*-47.77+$data19->bil*8.97+$data19->ggt*91.79}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 20--}}
                          <tr>
                            ...
                            @php
                                ...
                                $th = 0;
                            @endphp
                           <td>{{ $hasil1=$data20->alb*22.24+$data20->alp*88.96+$data20->alt*-110.99+$data20->ast*-47.77+$data20->bil*8.97+$data20->ggt*91.79}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
