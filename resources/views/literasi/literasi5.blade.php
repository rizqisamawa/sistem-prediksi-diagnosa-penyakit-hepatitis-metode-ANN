...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 5</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                 <td>{{ $hasil1=$data1->alb*18.73+$data1->alp*66.82+$data1->alt*-151.04+$data1->ast*-133.27+$data1->bil*25.08+$data1->ggt*112.4}}</td>
                         @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                 <td>{{ $hasil1=$data2->alb*18.73+$data2->alp*66.82+$data2->alt*-151.04+$data2->ast*-133.27+$data2->bil*25.08+$data2->ggt*112.4}}</td>
                 @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data3->alb*18.73+$data3->alp*66.82+$data3->alt*-151.04+$data3->ast*-133.27+$data3->bil*25.08+$data3->ggt*112.4}}</td>
                           @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data4->alb*18.73+$data4->alp*66.82+$data4->alt*-151.04+$data4->ast*-133.27+$data4->bil*25.08+$data4->ggt*112.4}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 5--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data5->alb*-20.15+$data5->alp*20.02+$data5->alt*-178.58+$data5->ast*-153.61+$data5->bil*8.07+$data5->ggt*81.98}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 6--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data6->alb*-20.15+$data6->alp*20.02+$data6->alt*-178.58+$data6->ast*-153.61+$data6->bil*8.07+$data6->ggt*81.98}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 7--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data7->alb*-20.15+$data7->alp*20.02+$data7->alt*-178.58+$data7->ast*-153.61+$data7->bil*8.07+$data7->ggt*81.98}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 8--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data8->alb*21.52+$data8->alp*57.19+$data8->alt*-162.83+$data8->ast*-137.59+$data8->bil*15.72+$data8->ggt*97.19}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 9--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data9->alb*21.52+$data9->alp*57.19+$data9->alt*-162.83+$data9->ast*-137.59+$data9->bil*15.72+$data9->ggt*97.19}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 10--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data10->alb*67.33+$data10->alp*116.14+$data10->alt*-141.95+$data10->ast*-118.51+$data10->bil*21.93+$data10->ggt*109.52}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 11--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data11->alb*67.33+$data11->alp*116.14+$data11->alt*-141.95+$data11->ast*-118.51+$data11->bil*21.93+$data11->ggt*109.52}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 12--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data12->alb*30.52+$data12->alp*63.58+$data12->alt*-160.04+$data12->ast*-142.36+$data12->bil*19.59+$data12->ggt*98.09}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 13--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data13->alb*30.52+$data13->alp*63.58+$data13->alt*-160.04+$data13->ast*-142.36+$data13->bil*19.59+$data13->ggt*98.09}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 14--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data14->alb*30.52+$data14->alp*63.58+$data14->alt*-160.04+$data14->ast*-142.36+$data14->bil*19.59+$data14->ggt*98.09}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 15--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data15->alb*30.52+$data15->alp*63.58+$data15->alt*-160.04+$data15->ast*-142.36+$data15->bil*19.59+$data15->ggt*98.09}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 16--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data16->alb*30.52+$data16->alp*63.58+$data16->alt*-160.04+$data16->ast*-142.36+$data16->bil*19.59+$data16->ggt*98.09}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 17--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data17->alb*-10.88+$data17->alp*11.29+$data17->alt*-179.3+$data17->ast*-168.73+$data17->bil*13.38+$data17->ggt*69.02}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 18--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data18->alb*-10.88+$data18->alp*11.29+$data18->alt*-179.3+$data18->ast*-168.73+$data18->bil*13.38+$data18->ggt*69.02}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 19--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data19->alb*28.99+$data19->alp*75.64+$data19->alt*-164.99+$data19->ast*-154.06+$data19->bil*19.95+$data19->ggt*86.84}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 20--}}
                      <tr>
                        ...
                        @php
                            ...
                            $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data20->alb*28.99+$data20->alp*75.64+$data20->alt*-164.99+$data20->ast*-154.06+$data20->bil*19.95+$data20->ggt*86.84}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
