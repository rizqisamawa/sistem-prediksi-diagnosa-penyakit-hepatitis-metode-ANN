...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 1</h3>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{($hasil1=$data1->alb*$w1+$data1->alp*$w2+$data1->alt*$w3+$data1->ast*$w4+$data1->bil*$w5+$data1->ggt*$w6)}}</td>
            ...
            {{-- baris 2 --}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data2->alb*-36.35+$data2->alp*-20.75+$data2->alt*31.93+$data2->ast*75.89+$data2->bil*-5.25+$data2->ggt*99.89}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 3 --}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data3->alb*-36.35+$data3->alp*-20.75+$data3->alt*31.93+$data3->ast*75.89+$data3->bil*-5.25+$data3->ggt*99.89}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 4--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data4->alb*-78.56+$data4->alp*-87.98+$data4->alt*-0.65+$data4->ast*28.55+$data4->bil*-10.74+$data4->ggt*70.01}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 5--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data5->alb*-78.56+$data5->alp*-87.98+$data5->alt*-0.65+$data5->ast*28.55+$data5->bil*-10.74+$data5->ggt*70.01}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 6--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data6->alb*-78.56+$data6->alp*-87.98+$data6->alt*-0.65+$data6->ast*28.55+$data6->bil*-10.74+$data6->ggt*70.01}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 7--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data7->alb*-41.12+$data7->alp*-49.01+$data7->alt*16+$data7->ast*46.28+$data7->bil*0.33+$data7->ggt*151.91}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 8--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data8->alb*0.55+$data8->alp*-11.84+$data8->alt*31.75+$data8->ast*62.3+$data8->bil*7.98+$data8->ggt*167.12}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 9--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data9->alb*-37.43+$data9->alp*-49.55+$data9->alt*-0.47+$data9->ast*34.31+$data9->bil*-6.51+$data9->ggt*147.77}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 10--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data10->alb*8.38+$data10->alp*9.4+$data10->alt*20.41+$data10->ast*53.39+$data10->bil*-0.3+$data10->ggt*160.1}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 11--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data11->alb*8.38+$data11->alp*9.4+$data11->alt*20.41+$data11->ast*53.39+$data11->bil*-0.3+$data11->ggt*160.1}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 12--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data12->alb*-28.43+$data12->alp*-43.16+$data12->alt*2.32+$data12->ast*29.54+$data12->bil*-2.64+$data12->ggt*148.67}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 13--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data13->alb*13.24+$data13->alp*21.46+$data13->alt*23.02+$data13->ast*52.22+$data13->bil*7.35+$data13->ggt*165.86}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 14--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data14->alb*-22.4+$data14->alp*-37.85+$data14->alt*-34.85+$data14->ast*16.67+$data14->bil*4.83+$data14->ggt*144.17}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 15--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data15->alb*12.79+$data15->alp*42.61+$data15->alt*-20.99+$data15->ast*38.36+$data15->bil*8.52+$data15->ggt*154.97}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 16--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data16->alb*12.79+$data16->alp*42.61+$data16->alt*-20.99+$data16->ast*38.36+$data16->bil*8.52+$data16->ggt*154.97}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 17--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data17->alb*-28.61+$data17->alp*-9.68+$data17->alt*-40.25+$data17->ast*11.99+$data17->bil*2.31+$data17->ggt*125.9}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 18--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data18->alb*-70.37+$data18->alp*-67.37+$data18->alt*-66.62+$data18->ast*-12.85+$data18->bil*-9.57+$data18->ggt*99.89}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 19--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data19->alb*-30.5+$data19->alp*-3.02+$data19->alt*-52.31+$data19->ast*1.82+$data19->bil*-3+$data19->ggt*117.71}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
          ...
          {{-- baris 20--}}
              <tr>
                ...
                $th = 0;
                @endphp
                <td>{{ $hasil1=$data20->alb*12.07+$data20->alp*52.51+$data20->alt*-36.47+$data20->ast*19.19+$data20->bil*5.91+$data20->ggt*129.86}}</td>
                @php
                if($hasil1<$th){
                  $aa=0;
                }else{
