...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 3</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                 <td>{{ $hasil1=$data1->alb*22.24+$data1->alp*88.96+$data1->alt*-110.99+$data1->ast*-47.77+$data1->bil*8.97+$data1->ggt*91.79}}</td>
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data2->alb*22.24+$data2->alp*88.96+$data2->alt*-110.99+$data2->ast*-47.77+$data2->bil*8.97+$data2->ggt*91.79}}</td>
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data3->alb*22.24+$data3->alp*88.96+$data3->alt*-110.99+$data3->ast*-47.77+$data3->bil*8.97+$data3->ggt*91.79}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data4->alb*-19.97+$data4->alp*21.73+$data4->alt*-143.57+$data4->ast*-95.11+$data4->bil*3.48+$data4->ggt*61.91}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 5--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data5->alb*-19.97+$data5->alp*21.73+$data5->alt*-143.57+$data5->ast*-95.11+$data5->bil*3.48+$data5->ggt*61.91}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 6--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                          <td>{{ $hasil1=$data6->alb*-19.97+$data6->alp*21.73+$data6->alt*-143.57+$data6->ast*-95.11+$data6->bil*3.48+$data6->ggt*61.91}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 7--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data7->alb*-19.97+$data7->alp*21.73+$data7->alt*-143.57+$data7->ast*-95.11+$data7->bil*3.48+$data7->ggt*61.91}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 8--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data8->alb*21.7+$data8->alp*58.9+$data8->alt*-127.82+$data8->ast*-79.09+$data8->bil*11.13+$data8->ggt*77.12}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 9--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data9->alb*21.7+$data9->alp*58.9+$data9->alt*-127.82+$data9->ast*-79.09+$data9->bil*11.13+$data9->ggt*77.12}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 10--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data10->alb*21.7+$data10->alp*58.9+$data10->alt*-127.82+$data10->ast*-79.09+$data10->bil*11.13+$data10->ggt*77.12}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 11--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data11->alb*21.7+$data11->alp*58.9+$data11->alt*-127.82+$data11->ast*-79.09+$data11->bil*11.13+$data11->ggt*77.12}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 12--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data12->alb*-15.11+$data12->alp*6.34+$data12->alt*-145.91+$data12->ast*-102.94+$data12->bil*8.79+$data12->ggt*65.69}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 13--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data13->alb*26.56+$data13->alp*70.96+$data13->alt*-125.21+$data13->ast*-80.26+$data13->bil*18.78+$data13->ggt*82.88}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 14--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data14->alb*26.56+$data14->alp*70.96+$data14->alt*-125.21+$data14->ast*-80.26+$data14->bil*18.78+$data14->ggt*82.88}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 15--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data15->alb*26.56+$data15->alp*70.96+$data15->alt*-125.21+$data15->ast*-80.26+$data15->bil*18.78+$data15->ggt*82.88}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 16--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                             <td>{{ $hasil1=$data16->alb*26.56+$data16->alp*70.96+$data16->alt*-125.21+$data16->ast*-80.26+$data16->bil*18.78+$data16->ggt*82.88}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 17--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data17->alb*-14.84+$data17->alp*18.67+$data17->alt*-144.47+$data17->ast*-106.63+$data17->bil*12.57+$data17->ggt*53.81}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 18--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data18->alb*-14.84+$data18->alp*18.67+$data18->alt*-144.47+$data18->ast*-106.63+$data18->bil*12.57+$data18->ggt*53.81}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 19--}}
                          <tr>
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data19->alb*25.03+$data19->alp*83.02+$data19->alt*-130.16+$data19->ast*-91.96+$data19->bil*19.14+$data19->ggt*71.63}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                      ...
                      {{-- baris 20--}}
                          <tr>
                            ...
                            @php
                                ...
                                $th = 0;
                            @endphp
                          <td>{{ $hasil1=$data20->alb*25.03+$data20->alp*83.02+$data20->alt*-130.16+$data20->ast*-91.96+$data20->bil*19.14+$data20->ggt*71.63}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
