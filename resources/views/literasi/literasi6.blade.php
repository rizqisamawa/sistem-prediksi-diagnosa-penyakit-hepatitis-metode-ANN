...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 6</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data1->alb*28.99+$data1->alp*75.64+$data1->alt*-164.99+$data1->ast*-154.06+$data1->bil*19.95+$data1->ggt*86.84}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data2->alb*28.99+$data2->alp*75.64+$data2->alt*-164.99+$data2->ast*-154.06+$data2->bil*19.95+$data2->ggt*86.84}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data3->alb*28.99+$data3->alp*75.64+$data3->alt*-164.99+$data3->ast*-154.06+$data3->bil*19.95+$data3->ggt*86.84}}</td>
                             @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data4->alb*28.99+$data4->alp*75.64+$data4->alt*-164.99+$data4->ast*-154.06+$data4->bil*19.95+$data4->ggt*86.84}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 5--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data5->alb*28.99+$data5->alp*75.64+$data5->alt*-164.99+$data5->ast*-154.06+$data5->bil*19.95+$data5->ggt*86.84}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 6--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data6->alb*-6.29+$data6->alp*8.95+$data6->alt*-194.33+$data6->ast*-176.38+$data6->bil*11.31+$data6->ggt*59.93}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 7--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data7->alb*31.15+$data7->alp*47.92+$data7->alt*-177.68+$data7->ast*-158.65+$data7->bil*22.38+$data7->ggt*141.83}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 8--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data8->alb*31.15+$data8->alp*47.92+$data8->alt*-177.68+$data8->ast*-158.65+$data8->bil*22.38+$data8->ggt*141.83}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 9--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data9->alb*31.15+$data9->alp*47.92+$data9->alt*-177.68+$data9->ast*-158.65+$data9->bil*22.38+$data9->ggt*141.83}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 10--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data10->alb*76.96+$data10->alp*106.87+$data10->alt*-156.8+$data10->ast*-139.57+$data10->bil*28.59+$data10->ggt*154.16}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 11--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data11->alb*76.96+$data11->alp*106.87+$data11->alt*-156.8+$data11->ast*-139.57+$data11->bil*28.59+$data11->ggt*154.16}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 12--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data12->alb*40.15+$data12->alp*54.31+$data12->alt*-174.89+$data12->ast*-163.42+$data12->bil*26.25+$data12->ggt*142.73}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 13--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data13->alb*40.15+$data13->alp*54.31+$data13->alt*-174.89+$data13->ast*-163.42+$data13->bil*26.25+$data13->ggt*142.73}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 14--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data14->alb*40.15+$data14->alp*54.31+$data14->alt*-174.89+$data14->ast*-163.42+$data14->bil*26.25+$data14->ggt*142.73}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 15--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data15->alb*40.15+$data15->alp*54.31+$data15->alt*-174.89+$data15->ast*-163.42+$data15->bil*26.25+$data15->ggt*142.73}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 16--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data16->alb*40.15+$data16->alp*54.31+$data16->alt*-174.89+$data16->ast*-163.42+$data16->bil*26.25+$data16->ggt*142.73}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 17--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data17->alb*-1.25+$data17->alp*2.02+$data17->alt*-194.15+$data17->ast*-189.79+$data17->bil*20.04+$data17->ggt*113.66}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 18--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data18->alb*-1.25+$data18->alp*2.02+$data18->alt*-194.15+$data18->ast*-189.79+$data18->bil*20.04+$data18->ggt*113.66}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 19--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data19->alb*38.62+$data19->alp*66.37+$data19->alt*-179.84+$data19->ast*-175.12+$data19->bil*26.61+$data19->ggt*131.48}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 20--}}
                      <tr>
                        ...
                        @php
                            ...
                            $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data20->alb*38.62+$data20->alp*66.37+$data20->alt*-179.84+$data20->ast*-175.12+$data20->bil*26.61+$data20->ggt*131.48}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
