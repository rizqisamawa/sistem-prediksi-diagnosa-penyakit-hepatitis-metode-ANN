...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 9</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data1->alb*47.35+$data1->alp*87.25+$data1->alt*-198.74+$data1->ast*-207.61+$data1->bil*21.84+$data1->ggt*94.67}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data2->alb*47.35+$data2->alp*87.25+$data2->alt*-198.74+$data2->ast*-207.61+$data2->bil*21.84+$data2->ggt*94.67}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data3->alb*47.35+$data3->alp*87.25+$data3->alt*-198.74+$data3->ast*-207.61+$data3->bil*21.84+$data3->ggt*94.67}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data4->alb*47.35+$data4->alp*87.25+$data4->alt*-198.74+$data4->ast*-207.61+$data4->bil*21.84+$data4->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 5--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data5->alb*47.35+$data5->alp*87.25+$data5->alt*-198.74+$data5->ast*-207.61+$data5->bil*21.84+$data5->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 6--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data6->alb*47.35+$data6->alp*87.25+$data6->alt*-198.74+$data6->ast*-207.61+$data6->bil*21.84+$data6->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 7--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data7->alb*47.35+$data7->alp*87.25+$data7->alt*-198.74+$data7->ast*-207.61+$data7->bil*21.84+$data7->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 8--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data8->alb*47.35+$data8->alp*87.25+$data8->alt*-198.74+$data8->ast*-207.61+$data8->bil*21.84+$data8->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 9--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data9->alb*47.35+$data9->alp*87.25+$data9->alt*-198.74+$data9->ast*-207.61+$data9->bil*21.84+$data9->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 10--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data10->alb*47.35+$data10->alp*87.25+$data10->alt*-198.74+$data10->ast*-207.61+$data10->bil*21.84+$data10->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 11--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data11->alb*47.35+$data11->alp*87.25+$data11->alt*-198.74+$data11->ast*-207.61+$data11->bil*21.84+$data11->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 12--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data12->alb*47.35+$data12->alp*87.25+$data12->alt*-198.74+$data12->ast*-207.61+$data12->bil*21.84+$data12->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 13--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data13->alb*47.35+$data13->alp*87.25+$data13->alt*-198.74+$data13->ast*-207.61+$data13->bil*21.84+$data13->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 14--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data14->alb*47.35+$data14->alp*87.25+$data14->alt*-198.74+$data14->ast*-207.61+$data14->bil*21.84+$data14->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 15--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data15->alb*47.35+$data15->alp*87.25+$data15->alt*-198.74+$data15->ast*-207.61+$data15->bil*21.84+$data15->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 16--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data16->alb*47.35+$data16->alp*87.25+$data16->alt*-198.74+$data16->ast*-207.61+$data16->bil*21.84+$data16->ggt*94.67}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 17--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data17->alb*5.95+$data17->alp*34.96+$data17->alt*-218+$data17->ast*-233.98+$data17->bil*15.63+$data17->ggt*65.6}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 18--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data18->alb*5.95+$data18->alp*34.96+$data18->alt*-218+$data18->ast*-233.98+$data18->bil*15.63+$data18->ggt*65.6}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 19--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data19->alb*45.82+$data19->alp*99.31+$data19->alt*-203.69+$data19->ast*-219.31+$data19->bil*22.2+$data19->ggt*83.42}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 20--}}
                      <tr>
                        ...
                        @php
                            ...
                            $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data20->alb*45.82+$data20->alp*99.31+$data20->alt*-203.69+$data20->ast*-219.31+$data20->bil*22.2+$data20->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
