...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 10</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data1->alb*45.82+$data1->alp*99.31+$data1->alt*-203.69+$data1->ast*-219.31+$data1->bil*22.2+$data1->ggt*83.42}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data2->alb*45.82+$data2->alp*99.31+$data2->alt*-203.69+$data2->ast*-219.31+$data2->bil*22.2+$data2->ggt*83.42}}</td>
                 @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data3->alb*45.82+$data3->alp*99.31+$data3->alt*-203.69+$data3->ast*-219.31+$data3->bil*22.2+$data3->ggt*83.42}}</td>
                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data4->alb*45.82+$data4->alp*99.31+$data4->alt*-203.69+$data4->ast*-219.31+$data4->bil*22.2+$data4->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 5--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data5->alb*45.82+$data5->alp*99.31+$data5->alt*-203.69+$data5->ast*-219.31+$data5->bil*22.2+$data5->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 6--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data6->alb*45.82+$data6->alp*99.31+$data6->alt*-203.69+$data6->ast*-219.31+$data6->bil*22.2+$data6->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 7--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data7->alb*45.82+$data7->alp*99.31+$data7->alt*-203.69+$data7->ast*-219.31+$data7->bil*22.2+$data7->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 8--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data8->alb*45.82+$data8->alp*99.31+$data8->alt*-203.69+$data8->ast*-219.31+$data8->bil*22.2+$data8->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 9--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data9->alb*45.82+$data9->alp*99.31+$data9->alt*-203.69+$data9->ast*-219.31+$data9->bil*22.2+$data9->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 10--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data10->alb*45.82+$data10->alp*99.31+$data10->alt*-203.69+$data10->ast*-219.31+$data10->bil*22.2+$data10->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 11--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data11->alb*45.82+$data11->alp*99.31+$data11->alt*-203.69+$data11->ast*-219.31+$data11->bil*22.2+$data11->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 12--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data12->alb*45.82+$data12->alp*99.31+$data12->alt*-203.69+$data12->ast*-219.31+$data12->bil*22.2+$data12->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 13--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data13->alb*45.82+$data13->alp*99.31+$data13->alt*-203.69+$data13->ast*-219.31+$data13->bil*22.2+$data13->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 14--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data14->alb*45.82+$data14->alp*99.31+$data14->alt*-203.69+$data14->ast*-219.31+$data14->bil*22.2+$data14->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 15--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data15->alb*45.82+$data15->alp*99.31+$data15->alt*-203.69+$data15->ast*-219.31+$data15->bil*22.2+$data15->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 16--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data16->alb*45.82+$data16->alp*99.31+$data16->alt*-203.69+$data16->ast*-219.31+$data16->bil*22.2+$data16->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 17--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data17->alb*45.82+$data17->alp*99.31+$data17->alt*-203.69+$data17->ast*-219.31+$data17->bil*22.2+$data17->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 18--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data18->alb*45.82+$data18->alp*99.31+$data18->alt*-203.69+$data18->ast*-219.31+$data18->bil*22.2+$data18->ggt*83.42}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
