...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 7</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data1->alb*38.62+$data1->alp*66.37+$data1->alt*-179.84+$data1->ast*-175.12+$data1->bil*26.61+$data1->ggt*131.48}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                  <td>{{ $hasil1=$data2->alb*38.62+$data2->alp*66.37+$data2->alt*-179.84+$data2->ast*-175.12+$data2->bil*26.61+$data2->ggt*131.48}}</td>
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                           <td>{{ $hasil1=$data3->alb*38.62+$data3->alp*66.37+$data3->alt*-179.84+$data3->ast*-175.12+$data3->bil*26.61+$data3->ggt*131.48}}</td>
                             @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                        ...
                        $th = 0;
                        @endphp
                       <td>{{ $hasil1=$data4->alb*38.62+$data4->alp*66.37+$data4->alt*-179.84+$data4->ast*-175.12+$data4->bil*26.61+$data4->ggt*131.48}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 5--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data5->alb*-0.26+$data5->alp*19.57+$data5->alt*-207.38+$data5->ast*-195.46+$data5->bil*9.6+$data5->ggt*101.06}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 6--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data6->alb*-0.26+$data6->alp*19.57+$data6->alt*-207.38+$data6->ast*-195.46+$data6->bil*9.6+$data6->ggt*101.06}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 7--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data7->alb*-0.26+$data7->alp*19.57+$data7->alt*-207.38+$data7->ast*-195.46+$data7->bil*9.6+$data7->ggt*101.06}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 8--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data8->alb*41.41+$data8->alp*56.74+$data8->alt*-191.63+$data8->ast*-179.44+$data8->bil*17.25+$data8->ggt*116.27}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 9--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data9->alb*41.41+$data9->alp*56.74+$data9->alt*-191.63+$data9->ast*-179.44+$data9->bil*17.25+$data9->ggt*116.27}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 10--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data10->alb*87.22+$data10->alp*115.69+$data10->alt*-170.75+$data10->ast*-160.36+$data10->bil*23.46+$data10->ggt*128.6}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 11--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data11->alb*87.22+$data11->alp*115.69+$data11->alt*-170.75+$data11->ast*-160.36+$data11->bil*23.46+$data11->ggt*128.6}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 12--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data12->alb*50.41+$data12->alp*63.13+$data12->alt*-188.84+$data12->ast*-184.21+$data12->bil*21.12+$data12->ggt*117.17}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 13--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data13->alb*50.41+$data13->alp*63.13+$data13->alt*-188.84+$data13->ast*-184.21+$data13->bil*21.12+$data13->ggt*117.17}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 14--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data14->alb*50.41+$data14->alp*63.13+$data14->alt*-188.84+$data14->ast*-184.21+$data14->bil*21.12+$data14->ggt*117.17}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 15--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data15->alb*50.41+$data15->alp*63.13+$data15->alt*-188.84+$data15->ast*-184.21+$data15->bil*21.12+$data15->ggt*117.17}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 16--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data16->alb*50.41+$data16->alp*63.13+$data16->alt*-188.84+$data16->ast*-184.21+$data16->bil*21.12+$data16->ggt*117.17}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 17--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data17->alb*9.01+$data17->alp*10.84+$data17->alt*-208.1+$data17->ast*-210.58+$data17->bil*14.91+$data17->ggt*88.1}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 18--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data18->alb*9.01+$data18->alp*10.84+$data18->alt*-208.1+$data18->ast*-210.58+$data18->bil*14.91+$data18->ggt*88.1}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 19--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data19->alb*48.88+$data19->alp*75.19+$data19->alt*-193.79+$data19->ast*-195.91+$data19->bil*21.48+$data19->ggt*105.92}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 20--}}
                      <tr>
                        ...
                        @php
                            ...
                            $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data20->alb*48.88+$data20->alp*75.19+$data20->alt*-193.79+$data20->ast*-195.91+$data20->bil*21.48+$data20->ggt*105.92}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
