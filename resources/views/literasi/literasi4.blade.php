...
<div class="main">
    ...
    <div class="panel-heading">
        <h3 class="panel-title">Perhitungan 4</h3>
    </div>
            ...
            <tbody>
              {{-- baris 1 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                 <td>{{ $hasil1=$data1->alb*25.03+$data1->alp*83.02+$data1->alt*-130.16+$data1->ast*-91.96+$data1->bil*19.14+$data1->ggt*71.63}}</td>                  
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
                <tr>
                  ...
                  $th = 0;
                  @endphp
                 <td>{{ $hasil1=$data2->alb*25.03+$data2->alp*83.02+$data2->alt*-130.16+$data2->ast*-91.96+$data2->bil*19.14+$data2->ggt*71.63}}</td>                  
                  @php
                  if($hasil1<$th){
                    $aa=0;
                  }else{
              ...
              {{-- baris 2 --}}
               ...
               {{-- baris 3 --}}
                            ...
                            $th = 0;
                            @endphp
                            <td>{{ $hasil1=$data3->alb*25.03+$data3->alp*83.02+$data3->alt*-130.16+$data3->ast*-91.96+$data3->bil*19.14+$data3->ggt*71.63}}</td>                            @php
                            if($hasil1<$th){
                              $aa=0;
                            }else{
                              $aa=1;
               ...
               {{-- baris 3 --}}
                      ...
                      {{-- baris 4--}}
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data4->alb*-17.18+$data4->alp*15.79+$data4->alt*-162.74+$data4->ast*-139.3+$data4->bil*13.65+$data4->ggt*41.75}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 5--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data5->alb*-17.18+$data5->alp*15.79+$data5->alt*-162.74+$data5->ast*-139.3+$data5->bil*13.65+$data5->ggt*41.75}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 6--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                        <td>{{ $hasil1=$data6->alb*-17.18+$data6->alp*15.79+$data6->alt*-162.74+$data6->ast*-139.3+$data6->bil*13.65+$data6->ggt*41.75}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 7--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data7->alb*20.26+$data7->alp*54.76+$data7->alt*-146.09+$data7->ast*-121.57+$data7->bil*24.72+$data7->ggt*123.65}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 8--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data8->alb*20.26+$data8->alp*54.76+$data8->alt*-146.09+$data8->ast*-121.57+$data8->bil*24.72+$data8->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 9--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data9->alb*20.26+$data9->alp*54.76+$data9->alt*-146.09+$data9->ast*-121.57+$data9->bil*24.72+$data9->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 10--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data10->alb*20.26+$data10->alp*54.76+$data10->alt*-146.09+$data10->ast*-121.57+$data10->bil*24.72+$data10->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 11--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data11->alb*20.26+$data11->alp*54.76+$data11->alt*-146.09+$data11->ast*-121.57+$data11->bil*24.72+$data11->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 12--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data12->alb*20.26+$data12->alp*54.76+$data12->alt*-146.09+$data12->ast*-121.57+$data12->bil*24.72+$data12->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 13--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data13->alb*20.26+$data13->alp*54.76+$data13->alt*-146.09+$data13->ast*-121.57+$data13->bil*24.72+$data13->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 14--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data14->alb*20.26+$data14->alp*54.76+$data14->alt*-146.09+$data14->ast*-121.57+$data14->bil*24.72+$data14->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 15--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data15->alb*20.26+$data15->alp*54.76+$data15->alt*-146.09+$data15->ast*-121.57+$data15->bil*24.72+$data15->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 16--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data16->alb*20.26+$data16->alp*54.76+$data16->alt*-146.09+$data16->ast*-121.57+$data16->bil*24.72+$data16->ggt*123.65}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 17--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data17->alb*-21.14+$data17->alp*2.47+$data17->alt*-165.35+$data17->ast*-147.94+$data17->bil*18.51+$data17->ggt*94.58}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 18--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data18->alb*-21.14+$data18->alp*2.47+$data18->alt*-165.35+$data18->ast*-147.94+$data18->bil*18.51+$data18->ggt*94.58}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 19--}}
                      <tr>
                        ...
                        $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data19->alb*18.73+$data19->alp*66.82+$data19->alt*-151.04+$data19->ast*-133.27+$data19->bil*25.08+$data19->ggt*112.4}}</td>
                        @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
                  ...
                  {{-- baris 20--}}
                      <tr>
                        ...
                        @php
                            ...
                            $th = 0;
                        @endphp
                         <td>{{ $hasil1=$data20->alb*18.73+$data20->alp*66.82+$data20->alt*-151.04+$data20->ast*-133.27+$data20->bil*25.08+$data20->ggt*112.4}}</td>
                         @php
                        if($hasil1<$th){
                          $aa=0;
                        }else{
